...
export function defaultInvoiceReminderCopy(): { subject: string; body: string } {
  return {
    ...
    body: [
      ...
      "@fakturor",
      "",
      "Vi påminner dig vänligen om ovanstående obetalda faktura/fakturor.",
      "",
      "Vi förstår att omständigheter ibland kan vara utmanande. Om du har några frågor, funderingar eller om det uppstått oklarheter kring fakturan, tveka inte att kontakta oss — vi finns här för att hjälpa dig.",
      "",
      "För att undvika förseningsavgifter och dröjsmålsränta uppmuntrar vi dig att betala så snart som möjligt.",
      "",
