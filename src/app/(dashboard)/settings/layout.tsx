...
import { User, Shield, UserCog, Link2, Tags, RefreshCw, Mail, FolderOpen, Database, BarChart3, Coins } from "lucide-react"
...
function getSettingsTabs(t: (key: string, fallback?: string) => string): SettingsTab[] {
  return [
    ...
    { label: t("settings.tabs.currencies", "Currencies"), href: "/settings/currencies", icon: Coins },
