const dictionaries = {
  en: {
    ...
    "mail.send.body": "Body",
    "mail.send.savedTemplateLocked": "Using saved template content. To edit fields, switch to Plain, Default, or Plain OS.",
  ...
  sv: {
    ...
    "mail.send.savedTemplateLocked": "Sparat mallinnehåll används. Byt till Plain, Default eller Plain OS för att redigera fälten.",
